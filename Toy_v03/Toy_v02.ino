...
int convertToBinary(){
  int result = 16;
  if(connectors[0] == 1 || connectors[5] == 1){
    if(connectors[0] == connectors[5]){
      result += B1000;
    }
    else if(connectors[1] == 1 || connectors[4] == 1){
      result += B1100;
    }
    else if(connectors[2] == 1 || connectors[3] == 1){
      result += B1010;
    }
    else{
      result += B1001;
